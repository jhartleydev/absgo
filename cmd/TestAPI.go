...
var TestAPICmd = &cobra.Command{
	Use:   "TestAPI",
	Short: "Runs a call to the API to see what the response is",
	Long:  `Using the net/http module, this command calls the base ABS url at "https://data.api.abs.gov.au/".`,
